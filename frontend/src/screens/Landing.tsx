        ...
        <div className="grid lg:grid-cols-[1.6fr_1fr]">
          ...
          <div className="px-5 pt-5 pb-6 lg:px-9 lg:pt-12 lg:pb-10">
            ...
            <div className="mt-4 space-y-4 lg:mt-6">
              ...
              <a
                href="https://github.com/Bonk1211/PRISM---MASAHackathon2026"
                target="_blank"
                rel="noopener noreferrer"
                className="reveal reveal-d6 group mt-4 flex items-center justify-center gap-2 border-2 border-ink bg-ink px-5 py-3 text-[13px] font-bold uppercase tracking-eyebrow text-paper transition hover:bg-paper hover:text-ink lg:mt-6 lg:py-4 lg:text-[14px]"
              >
                <svg
                  aria-hidden="true"
                  viewBox="0 0 24 24"
